...
# mqtt_table = UARTTable(MCU_COM_PORT, logging_level=logging.DEBUG)
# nhatlv
...
class ModalTimerOperator(bpy.types.Operator):
    ...
    def modal(self, context, event):
        ...
        if event.type == "TIMER":
            ...
            q0 = mqtt_table.get("/joint/0")
            q1 = mqtt_table.get("/joint/1")
